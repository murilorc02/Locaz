...
export const workspaces: Workspace[] = [
  {
    ...
    amenities: ['wifi-gratis', 'cafe-gratis', 'cadeiras-ergonomicas', 'projetor', 'espaco-descompressao', 'espaco-kids'],
    available: true,
  ...
  },
  {
    ...
    amenities: ['wifi-gratis', 'cafe-gratis'],
    available: true,
  ...
  },
  {
    ...
    amenities: ['wifi-gratis', 'cadeiras-ergonomicas'],
    available: true,
    category: 'meeting-room'
  },
  {
    ...
    amenities: ['wifi-gratis', 'cafe-gratis', 'cadeiras-ergonomicas'],
    available: true,
