...
const BusinessDashboard = () => {
  ...
  const totalLocations = businessLocations.length;
  const totalWorkspaces = businessLocations.reduce((acc, location) => 
    acc + getWorkspacesByLocation(location.id).length, 0
  );
                ...
                <CardContent>
                  {businessLocations.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {businessLocations.slice(0, 3).map(location => (
