...
export class CreateData1759689521299 implements MigrationInterface {
    name = 'CreateData1759689521299'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sala" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "descricao" text, "capacidade" integer NOT NULL, "categoria" text NOT NULL, "precoHora" numeric(10,2) NOT NULL, "reservaGratuita" boolean NOT NULL DEFAULT false, "comodidades" text array NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "predio_id" integer, CONSTRAINT "PK_4e5fe0d3e30b64508d2a59daa40" PRIMARY KEY ("id"))`);
